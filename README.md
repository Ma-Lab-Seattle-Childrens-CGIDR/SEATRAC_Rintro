...
2. **Feb 5**: Data manipulation with tidyverse, basic plotting. [tutorial link](https://ma-lab-seattle-childrens-cgidr.github.io/SEATRAC_Rintro/Session2_tidyR_Plotting.v1.html). [link to code cheatsheet](https://ma-lab-seattle-childrens-cgidr.github.io/SEATRAC_Rintro/Session2_cheatsheet2.html).[video link](https://youtu.be/bAYNW0EefGA).
