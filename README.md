...
## Sessions
1.  **Jan 15**: R/Rstudio basics, importing and subsetting data, intro to libraries. [tutorial link](https://ma-lab-seattle-childrens-cgidr.github.io/SEATRAC_Rintro/Rintro)
