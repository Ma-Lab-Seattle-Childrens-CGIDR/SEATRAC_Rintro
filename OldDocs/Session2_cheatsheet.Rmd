---
title: "Session 2 Command Cheatsheet"
author: "Ling Wei"
...
First, loading the library and the data:
```{r initiating, results='hide'}
# load package
library(tidyverse)
...
# Data specifications
```{r data specifications, results = 'hide'}
