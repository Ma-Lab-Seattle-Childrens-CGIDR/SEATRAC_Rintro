...
This kind of subsetting enables you to perform comparative analyses. As an example, we will perform a t-test, comparing the distribution of BMI in patients with and without heart disease:
...
summary(lm(data$BMI ~ FactorGender + FactorSmoking + FactorExercise))
```
