# SEATRAC R Intro Workshops 2026

Thursday January 15 and February 5, 2026
12:30pm - 2pm Pacific Time

## Hybrid ways to join

**Seattle:** UW [SLU F106](https://maps.app.goo.gl/SZxPtqPX7h7RdjEn9)
**Zoom:** link provided with registration: [Registration link](https://forms.cloud.microsoft/r/9UmWbNSnPV)

## Sessions

1. **Jan 15**: R/Rstudio basics, importing and subsetting data, intro to libraries. [tutorial link](./Session1_Rbasics.html). [video link](https://youtu.be/e_emSu9dX1o).
2. **Feb 5**: Data manipulation with tidyverse, basic plotting. [tutorial link](./Session2_tidyR_Plotting.v1.html). [link to code cheatsheet](./Session2_cheatsheet2.html). [video link](https://youtu.be/bAYNW0EefGA).



## Installation links

Please try to download and install R and RStudio prior to the workshop sessions

1. [Installing R](https://cran.r-project.org/)
2. [Installing Rstudio](https://posit.co/download/rstudio-desktop/)
