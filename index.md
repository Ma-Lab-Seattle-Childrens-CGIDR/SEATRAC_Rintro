...
2. **Feb 5**: Data manipulation with tidyverse, basic plotting. [tutorial link](./Session2_tidyR_Plotting.v1.html). [link to code cheatsheet](./Session2_cheatsheet2.html).
